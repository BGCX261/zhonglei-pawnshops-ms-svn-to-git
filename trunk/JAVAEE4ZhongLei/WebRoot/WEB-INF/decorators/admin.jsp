...
<!-- oncontextmenu="self.event.returnValue=false" onselectstart="self.event.returnValue=false" ondrag="return false" onmousedown="top.shiftStop(self)" -->
<div id="container">
<div id="header">
...
<div align="center"><a
	href="<s:url value="getByMonth.action" namespace="admin" />"><img
	src="../images/icon/SplitClass3.gif" width="32" height="32"
	style="margin: 55px 75px 15px 75px; border: 0px" /></a><br />
<strong>月统计表</strong></div>
</div>
<div style="width: 100%; height: 25%">
<div align="center"><a
	href="<s:url value="addUserList.action" namespace="admin" />"><img
	src="../images/icon/department.gif" width="32" height="32"
	style="margin: 55px 75px 15px 75px; border: 0px" /></a><br />
<strong>添加员工</strong></div>
</div>
<div style="width: 100%; height: 25%">
<div align="center"><a
	href="<s:url value="addPawncheck.action" namespace="admin" />"><img
	src="../images/icon/RegStaticies.gif" width="32" height="32"
	style="margin: 55px 75px 15px 75px; border: 0px" /></a><br />
<strong>添加当票</strong></div>
</div>
<div style="width: 100%; height: 25%">
<div align="center"><a
	href="<s:url value="BeSoldOrBlank.action" namespace="admin" />"><img
	src="../images/icon/DormChange.gif" width="32" height="32"
	style="margin: 55px 75px 15px 75px; border: 0px" /></a><br />
<strong>绝当 废票</strong></div>
</div>
<!-- end #sidebar1 --></div>
<div id="mainContent">
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td><img src="../images/icon/5.gif" alt="帮助" width="33"
			height="30" class="hand"
			onClick="window.open('/WinReadme.htm','','width=440,height=320')"></td>
